    ...
    <div id="top"><!-- Top Begin -->
        ...
        <div class="container"><!-- container Begin -->
            ...
            <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
                ...
                <a href="checkout.php"> <?php items(); ?> Sản phẩm trong giỏ hàng | Tổng: <?php total_price(); ?> </a>
        ...
        <div class="container"><!-- container Begin -->
            ...
            <div class="navbar-header"><!-- navbar-header Begin -->
                ...
                <a href="../index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                    ...
                    <img src="images/logo-mobile.png" alt="M-dev-Store Logo Mobile" class="visible-xs">
                   ...
                   <h1 align="center"> Vui lòng xác nhận thanh toán của bạn</h1>
                    ...
                    <form action="confirm.php?update_id=<?php echo $order_id; ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                        ...
                        <div class="form-group"><!-- form-group Begin -->
                            ...
                            <label> ID giao dịch / tham chiếu: </label>
                    ...
                    <?php 
                        if(isset($_POST['confirm_payment'])){
                            ...
                            if($run_pending_order){
                                echo "<script>alert('Cảm ơn bạn đã mua hàng, đơn đặt hàng của bạn sẽ được hoàn thành trong vòng 24h')</script>";
