<center><!--  center Begin  -->
    ...
    <p class="lead"> Đơn đặt hàng của bạn ở nơi</p>
    
    <p class="text-muted">
        
        Nếu bạn có bất kỳ câu hỏi nào hãy <a href="../contact.php">liên hệ với chúng tôi</a>. Dịch vụ chăm sóc khách hàng của chúng tôi làm việc <strong>24/7</strong>
    ...
    <table class="table table-bordered table-hover"><!--  table table-bordered table-hover Begin  -->
        ...
        <thead><!--  thead Begin  -->
            ...
            <tr><!--  tr Begin  -->
                ...
                <th> Số lượng: </th>
                <th> Ngày đặt hàng:</th>
                <th> Có trả tiền / chưa trả tiền: </th>
                <th> Trạng thái: </th>
