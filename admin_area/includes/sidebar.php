<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    <div class="navbar-header"><!-- navbar-header begin -->
        ...
        <a href="index.php?dashboard" class="navbar-brand">Khu vực quản trị</a>
    ...
    <ul class="nav navbar-right top-nav"><!-- nav navbar-right top-nav begin -->
        ...
        <li class="dropdown"><!-- dropdown begin -->
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><!-- dropdown-toggle begin -->
                ...
                <i class="fa fa-user"></i> MrLP <b class="caret"></b>
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#slides"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-gear"></i> Danh sách
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="slides" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_slide"> Thêm danh sách </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_slides"> Xem danh sách </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_payments"><!-- a href begin -->
                    <i class="fa fa-fw fa-money"></i> Xem các khoản thanh toán
                </a><!-- a href finish -->
            </li><!-- li finish -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="users" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?user_profile"> Chỉnh sửa hồ sơ người dùng </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
